...
export default function Upcoming() {
    ...
    return (
        <>
            ...
            {upcomingData?.length ? <div className="flex flex-wrap ">

                {upcomingData?.map((item) => <div key={item.id} className='group my-10 mx-auto lg:w-1/3 p-8 relative overflow-hidden'>
